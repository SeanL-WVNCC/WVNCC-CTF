...
function generatePage(string $mainContent): string {
    ...
    $result .= "<footer>";
    $leftFooter = "";
    $leftFooter .= "<h2>Legal</h2>";
    $leftFooter .= "<p>Northern Phish &amp; Loan, member FDIC.</p>";
    $leftFooter .= "<p>ADA NOTICE: This site meets or exceeds <abbr title=\"Web Content Accessibility Guidlines version 2.1\">WCAG 2.1</abbr>. Trust us, we <em>totally</em> checked.</p>";
    $leftFooter .= "<p><del>Diversity, equity and inclusion</del></p>";
    $leftFooter .= "<p><a href=\"/legal.php#dark-vault-terms\">Dark Vault Credit terms of service</a></p>";
    $leftFooter .= "<p><a href=\"/legal.php#attribution\">Attributions</a></p>";
    $rightFooter = "";
    $rightFooter .= "<h2>Quick Links</h2>";
    $rightFooter .= "<nav><ul>";
    $rightFooter .= "<li><a href=\"login.php\">Login</a></li>";
    $rightFooter .= "<li><a href=\"loanApplication.php\">Loan Application</a></li>";
    $rightFooter .= "<li><a href=\"feedback.php\">Contact</a></li>";
    $rightFooter .= "<li><a href=\"about.php\">About</a></li>";
    $rightFooter .= "<li><a title=\"lol nope\" disabled>Careers</a></li>";
    $rightFooter .= "</ul><nav>";
    $rightFooter2 = "";
    $rightFooter2 .= "<h2>Locations</h2>";
    $rightFooter2 .= "<ul>";
    $rightFooter2 .= "<li><a href=\"/locations.php#weirton\">Weirton</a></li>";
    $rightFooter2 .= "<li><a href=\"/locations.php#wheeling\">Wheeling</a></li>";
    $rightFooter2 .= "<li><a href=\"/locations.php#new-martinsville\">New Martinsville</a></li>";
    $rightFooter2 .= "</ul>";
    $result .= threeColumnLayout(presentationalWrapper($leftFooter), presentationalWrapper($rightFooter2), presentationalWrapper($rightFooter));
    $result .= "<hr>";
    $realDisclamer = "";
