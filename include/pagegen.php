...
function generatePage(string $mainContent): string {
    ...
    $footerLeft .= "<p><del>Diversity, equity and inclusion</del></p>";
    ...
    $footerMiddle .= "<ul>";
    $footerMiddle .= "<li><a href=\"/locations.php#weirton\">Weirton</a></li>";
    $footerMiddle .= "<li><a href=\"/locations.php#wheeling\">Wheeling</a></li>";
    $footerMiddle .= "<li><a href=\"/locations.php#new-martinsville\">New Martinsville</a></li>";
    $footerMiddle .= "</ul>";
    $footerRight = "";
