...
function generateAccountCard(string $accountName, string $accountNumberLastFour, float $currentBalance, string $linkHref) {
    ...
    $accountNameAndNumberSection = "<div class=\"account-name-and-number-section\"><img src=\"img/bank-icon.svg\"><div class=\"account-type-section\"><p class=\"account-name\">$accountName account</p><p>Account #$accountNumberLastFour</p></div></div>";
