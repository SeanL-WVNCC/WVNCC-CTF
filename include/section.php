<section class ="offers">
    <div>
        ...
        <p>Here is some placeholder text for another account offer.</p>
    </div>
    <div>
        <h2>Student account offer</h2>
        <p>Check our our special account just for students!</p>
    </div>
    <div>
        <h2>Mobile app</h2>
        <p>Manage your finanaces on the go with the nonexistent Northern Phish &amp; Loan mobile app!</p>
        <p><a href="https://play.google.com/store/apps/details?id=edu.wvncc.northernphish" target="_blank">Download from Google Play for Android</a></p>
    </div>
</section>
